...
architecture behav of ipv4_top is 
    ...
    "ipv4_top,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xcu280-fsvh2892-2L-e,HLS_INPUT_CLOCK=3.200000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.338000,HLS_SYN_LAT=4,HLS_SYN_TPT=1,HLS_SYN_MEM=58,HLS_SYN_DSP=0,HLS_SYN_FF=5939,HLS_SYN_LUT=4947,HLS_VERSION=2020_1}";
    ...
    signal process_ipv4_512_U0_rx_process2dropFifo_1_1_din : STD_LOGIC_VECTOR (511 downto 0);
    signal process_ipv4_512_U0_rx_process2dropFifo_1_1_write : STD_LOGIC;
    signal process_ipv4_512_U0_rx_process2dropFifo_2_0_din : STD_LOGIC_VECTOR (63 downto 0);
    signal process_ipv4_512_U0_rx_process2dropFifo_2_0_write : STD_LOGIC;
    signal process_ipv4_512_U0_rx_process2dropFifo_s_2_din : STD_LOGIC_VECTOR (0 downto 0);
    signal process_ipv4_512_U0_rx_process2dropFifo_s_2_write : STD_LOGIC;
    ...
    signal process_ipv4_512_U0_MetaOut_V_TDATA : STD_LOGIC_VECTOR (47 downto 0);
    signal process_ipv4_512_U0_MetaOut_V_TVALID : STD_LOGIC;
    ...
    signal ipv4_drop_optional_i_U0_rx_process2dropFifo_1_1_read : STD_LOGIC;
    signal ipv4_drop_optional_i_U0_rx_process2dropFifo_2_0_read : STD_LOGIC;
    signal ipv4_drop_optional_i_U0_rx_process2dropFifo_s_2_read : STD_LOGIC;
    signal ipv4_drop_optional_i_U0_rx_process2dropLengt_1_read : STD_LOGIC;
    signal ipv4_drop_optional_i_U0_m_axis_rx_data_TDATA : STD_LOGIC_VECTOR (511 downto 0);
    signal ipv4_drop_optional_i_U0_m_axis_rx_data_TVALID : STD_LOGIC;
    signal ipv4_drop_optional_i_U0_m_axis_rx_data_TKEEP : STD_LOGIC_VECTOR (63 downto 0);
    signal ipv4_drop_optional_i_U0_m_axis_rx_data_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal ipv4_lshiftWordByOct_U0_s_axis_tx_data_TREADY : STD_LOGIC;
    signal ipv4_generate_ipv4_U0_ap_start : STD_LOGIC;
    signal ipv4_generate_ipv4_U0_ap_done : STD_LOGIC;
    signal ipv4_generate_ipv4_U0_ap_continue : STD_LOGIC;
    signal ipv4_generate_ipv4_U0_ap_idle : STD_LOGIC;
    signal ipv4_generate_ipv4_U0_ap_ready : STD_LOGIC;
    signal ipv4_generate_ipv4_U0_tx_shift2ipv4Fifo_V_1_read : STD_LOGIC;
    signal ipv4_generate_ipv4_U0_tx_shift2ipv4Fifo_V_2_read : STD_LOGIC;
    signal ipv4_generate_ipv4_U0_tx_shift2ipv4Fifo_V_s_read : STD_LOGIC;
    signal ipv4_generate_ipv4_U0_txEng_ipMetaDataFifoIn_V_TREADY : STD_LOGIC;
    signal ipv4_generate_ipv4_U0_m_axis_tx_data_TDATA : STD_LOGIC_VECTOR (511 downto 0);
    signal ipv4_generate_ipv4_U0_m_axis_tx_data_TVALID : STD_LOGIC;
    signal ipv4_generate_ipv4_U0_m_axis_tx_data_TKEEP : STD_LOGIC_VECTOR (63 downto 0);
    signal ipv4_generate_ipv4_U0_m_axis_tx_data_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal rx_process2dropFifo_1_1_full_n : STD_LOGIC;
    signal rx_process2dropFifo_1_1_dout : STD_LOGIC_VECTOR (511 downto 0);
    signal rx_process2dropFifo_1_1_empty_n : STD_LOGIC;
    signal rx_process2dropFifo_2_0_full_n : STD_LOGIC;
    signal rx_process2dropFifo_2_0_dout : STD_LOGIC_VECTOR (63 downto 0);
    ...
    component ipv4_generate_ipv4 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    ...
    ipv4_generate_ipv4_U0 : component ipv4_generate_ipv4
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    rx_process2dropFifo_1_1_U : component fifo_w512_d8_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    rx_process2dropFifo_2_0_U : component fifo_w64_d8_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ipv4_generate_ipv4_U0_ap_continue <= ap_const_logic_1;
    ipv4_generate_ipv4_U0_ap_start <= ap_const_logic_1;
    ...
    m_axis_rx_data_TLAST <= ipv4_drop_optional_i_U0_m_axis_rx_data_TLAST;
    m_axis_rx_data_TVALID <= ipv4_drop_optional_i_U0_m_axis_rx_data_TVALID;
    m_axis_rx_meta_V_TDATA <= process_ipv4_512_U0_MetaOut_V_TDATA;
    m_axis_rx_meta_V_TVALID <= process_ipv4_512_U0_MetaOut_V_TVALID;
    m_axis_tx_data_TDATA <= ipv4_generate_ipv4_U0_m_axis_tx_data_TDATA;
    m_axis_tx_data_TKEEP <= ipv4_generate_ipv4_U0_m_axis_tx_data_TKEEP;
    m_axis_tx_data_TLAST <= ipv4_generate_ipv4_U0_m_axis_tx_data_TLAST;
    m_axis_tx_data_TVALID <= ipv4_generate_ipv4_U0_m_axis_tx_data_TVALID;
    ...
    s_axis_rx_data_TREADY <= process_ipv4_512_U0_s_axis_rx_data_TREADY;
    s_axis_tx_data_TREADY <= ipv4_lshiftWordByOct_U0_s_axis_tx_data_TREADY;
    s_axis_tx_meta_V_TREADY <= ipv4_generate_ipv4_U0_txEng_ipMetaDataFifoIn_V_TREADY;
end behav;
