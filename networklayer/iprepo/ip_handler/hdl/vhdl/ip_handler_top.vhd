...
architecture behav of ip_handler_top is 
    ...
    signal detect_eth_protocol_U0_ethDataFifo_V_data_V_din : STD_LOGIC_VECTOR (511 downto 0);
    signal detect_eth_protocol_U0_ethDataFifo_V_data_V_write : STD_LOGIC;
    signal detect_eth_protocol_U0_ethDataFifo_V_keep_V_din : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal route_by_eth_protoco_U0_ipv6ShiftFifo_V_data_din : STD_LOGIC_VECTOR (511 downto 0);
    signal route_by_eth_protoco_U0_ipv6ShiftFifo_V_data_write : STD_LOGIC;
    signal route_by_eth_protoco_U0_ipv6ShiftFifo_V_keep_din : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal route_by_eth_protoco_U0_ipv4ShiftFifo_V_data_din : STD_LOGIC_VECTOR (511 downto 0);
    signal route_by_eth_protoco_U0_ipv4ShiftFifo_V_data_write : STD_LOGIC;
    signal route_by_eth_protoco_U0_ipv4ShiftFifo_V_keep_din : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal route_by_eth_protoco_U0_m_axis_arp_TDATA : STD_LOGIC_VECTOR (511 downto 0);
    signal route_by_eth_protoco_U0_m_axis_arp_TVALID : STD_LOGIC;
    signal route_by_eth_protoco_U0_m_axis_arp_TKEEP : STD_LOGIC_VECTOR (63 downto 0);
    signal route_by_eth_protoco_U0_m_axis_arp_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_sync_continue : STD_LOGIC;
    signal ip_handler_rshiftWor_1_U0_ap_start : STD_LOGIC;
    signal ip_handler_rshiftWor_1_U0_ap_done : STD_LOGIC;
    signal ip_handler_rshiftWor_1_U0_ap_continue : STD_LOGIC;
    signal ip_handler_rshiftWor_1_U0_ap_idle : STD_LOGIC;
    signal ip_handler_rshiftWor_1_U0_ap_ready : STD_LOGIC;
    signal ip_handler_rshiftWor_1_U0_ipv4ShiftFifo_V_data_read : STD_LOGIC;
    signal ip_handler_rshiftWor_1_U0_ipv4ShiftFifo_V_keep_read : STD_LOGIC;
    signal ip_handler_rshiftWor_1_U0_ipv4ShiftFifo_V_last_read : STD_LOGIC;
    signal ip_handler_rshiftWor_1_U0_ipDataFifo_V_din : STD_LOGIC_VECTOR (576 downto 0);
    signal ip_handler_rshiftWor_1_U0_ipDataFifo_V_write : STD_LOGIC;
    signal ip_handler_rshiftWor_U0_ap_start : STD_LOGIC;
    signal ip_handler_rshiftWor_U0_ap_done : STD_LOGIC;
    signal ip_handler_rshiftWor_U0_ap_continue : STD_LOGIC;
    signal ip_handler_rshiftWor_U0_ap_idle : STD_LOGIC;
    signal ip_handler_rshiftWor_U0_ap_ready : STD_LOGIC;
    signal ip_handler_rshiftWor_U0_ipv6ShiftFifo_V_data_read : STD_LOGIC;
    signal ip_handler_rshiftWor_U0_ipv6ShiftFifo_V_keep_read : STD_LOGIC;
    signal ip_handler_rshiftWor_U0_ipv6ShiftFifo_V_last_read : STD_LOGIC;
    signal ip_handler_rshiftWor_U0_ipv6DataFifo_V_data_s_din : STD_LOGIC_VECTOR (511 downto 0);
    signal ip_handler_rshiftWor_U0_ipv6DataFifo_V_data_s_write : STD_LOGIC;
    signal ip_handler_rshiftWor_U0_ipv6DataFifo_V_keep_s_din : STD_LOGIC_VECTOR (63 downto 0);
    signal ip_handler_rshiftWor_U0_ipv6DataFifo_V_keep_s_write : STD_LOGIC;
    signal ip_handler_rshiftWor_U0_ipv6DataFifo_V_last_s_din : STD_LOGIC_VECTOR (0 downto 0);
    signal ip_handler_rshiftWor_U0_ipv6DataFifo_V_last_s_write : STD_LOGIC;
    ...
    signal extract_ip_meta_512_U0_ipDataFifo_V_read : STD_LOGIC;
    signal extract_ip_meta_512_U0_ipDataMetaFifo_V_dat_din : STD_LOGIC_VECTOR (511 downto 0);
    signal extract_ip_meta_512_U0_ipDataMetaFifo_V_dat_write : STD_LOGIC;
    signal extract_ip_meta_512_U0_ipDataMetaFifo_V_kee_din : STD_LOGIC_VECTOR (63 downto 0);
    signal extract_ip_meta_512_U0_ipDataMetaFifo_V_kee_write : STD_LOGIC;
    signal extract_ip_meta_512_U0_ipDataMetaFifo_V_las_din : STD_LOGIC_VECTOR (0 downto 0);
    signal extract_ip_meta_512_U0_ipDataMetaFifo_V_las_write : STD_LOGIC;
    signal extract_ip_meta_512_U0_validIpAddressFifo_V_din : STD_LOGIC_VECTOR (0 downto 0);
    signal extract_ip_meta_512_U0_validIpAddressFifo_V_write : STD_LOGIC;
    signal extract_ip_meta_512_U0_ipv4ProtocolFifo_V_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal extract_ip_meta_512_U0_ipv4ProtocolFifo_V_V_write : STD_LOGIC;
    signal ip_handler_compute_i_U0_ap_start : STD_LOGIC;
    signal ip_handler_compute_i_U0_ap_done : STD_LOGIC;
    signal ip_handler_compute_i_U0_ap_continue : STD_LOGIC;
    signal ip_handler_compute_i_U0_ap_idle : STD_LOGIC;
    signal ip_handler_compute_i_U0_ap_ready : STD_LOGIC;
    signal ip_handler_compute_i_U0_ipDataMetaFifo_V_dat_read : STD_LOGIC;
    signal ip_handler_compute_i_U0_ipDataMetaFifo_V_kee_read : STD_LOGIC;
    signal ip_handler_compute_i_U0_ipDataMetaFifo_V_las_read : STD_LOGIC;
    signal ip_handler_compute_i_U0_ipDataCheckFifo_V_din : STD_LOGIC_VECTOR (576 downto 0);
    signal ip_handler_compute_i_U0_ipDataCheckFifo_V_write : STD_LOGIC;
    signal ip_handler_compute_i_U0_iph_subSumsFifoOut_V_din : STD_LOGIC_VECTOR (543 downto 0);
    signal ip_handler_compute_i_U0_iph_subSumsFifoOut_V_write : STD_LOGIC;
    signal ip_handler_check_ipv_U0_ap_start : STD_LOGIC;
    signal ip_handler_check_ipv_U0_ap_done : STD_LOGIC;
    signal ip_handler_check_ipv_U0_ap_continue : STD_LOGIC;
    signal ip_handler_check_ipv_U0_ap_idle : STD_LOGIC;
    signal ip_handler_check_ipv_U0_ap_ready : STD_LOGIC;
    signal ip_handler_check_ipv_U0_iph_subSumsFifoOut_V_read : STD_LOGIC;
    signal ip_handler_check_ipv_U0_validChecksumFifo_V_din : STD_LOGIC_VECTOR (0 downto 0);
    signal ip_handler_check_ipv_U0_validChecksumFifo_V_write : STD_LOGIC;
    ...
    signal ip_invalid_dropper_U0_ipDataDropFifo_V_din : STD_LOGIC_VECTOR (576 downto 0);
    ...
    signal cut_length_U0_ipDataDropFifo_V_read : STD_LOGIC;
    signal cut_length_U0_ipDataCutFifo_V_din : STD_LOGIC_VECTOR (576 downto 0);
    signal cut_length_U0_ipDataCutFifo_V_write : STD_LOGIC;
    ...
    signal detect_ipv4_protocol_U0_udpDataFifo_V_din : STD_LOGIC_VECTOR (576 downto 0);
    signal detect_ipv4_protocol_U0_udpDataFifo_V_write : STD_LOGIC;
    signal detect_ipv4_protocol_U0_m_axis_icmp_TDATA : STD_LOGIC_VECTOR (511 downto 0);
    signal detect_ipv4_protocol_U0_m_axis_icmp_TVALID : STD_LOGIC;
    signal detect_ipv4_protocol_U0_m_axis_icmp_TKEEP : STD_LOGIC_VECTOR (63 downto 0);
    signal detect_ipv4_protocol_U0_m_axis_icmp_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal detect_ipv4_protocol_U0_m_axis_tcp_TDATA : STD_LOGIC_VECTOR (511 downto 0);
    signal detect_ipv4_protocol_U0_m_axis_tcp_TVALID : STD_LOGIC;
    signal detect_ipv4_protocol_U0_m_axis_tcp_TKEEP : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal detect_ipv6_protocol_U0_m_axis_icmpv6_TDATA : STD_LOGIC_VECTOR (511 downto 0);
    signal detect_ipv6_protocol_U0_m_axis_icmpv6_TVALID : STD_LOGIC;
    signal detect_ipv6_protocol_U0_m_axis_icmpv6_TKEEP : STD_LOGIC_VECTOR (63 downto 0);
    signal detect_ipv6_protocol_U0_m_axis_icmpv6_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal detect_ipv6_protocol_U0_m_axis_ipv6udp_TDATA : STD_LOGIC_VECTOR (511 downto 0);
    signal detect_ipv6_protocol_U0_m_axis_ipv6udp_TVALID : STD_LOGIC;
    signal detect_ipv6_protocol_U0_m_axis_ipv6udp_TKEEP : STD_LOGIC_VECTOR (63 downto 0);
    signal detect_ipv6_protocol_U0_m_axis_ipv6udp_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal ip_handler_duplicate_U0_ap_start : STD_LOGIC;
    signal ip_handler_duplicate_U0_ap_done : STD_LOGIC;
    signal ip_handler_duplicate_U0_ap_continue : STD_LOGIC;
    signal ip_handler_duplicate_U0_ap_idle : STD_LOGIC;
    signal ip_handler_duplicate_U0_ap_ready : STD_LOGIC;
    signal ip_handler_duplicate_U0_udpDataFifo_V_read : STD_LOGIC;
    signal ip_handler_duplicate_U0_m_axis_udp_TDATA : STD_LOGIC_VECTOR (511 downto 0);
    signal ip_handler_duplicate_U0_m_axis_udp_TVALID : STD_LOGIC;
    signal ip_handler_duplicate_U0_m_axis_udp_TKEEP : STD_LOGIC_VECTOR (63 downto 0);
    signal ip_handler_duplicate_U0_m_axis_udp_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal ip_handler_duplicate_U0_m_axis_roce_TDATA : STD_LOGIC_VECTOR (511 downto 0);
    signal ip_handler_duplicate_U0_m_axis_roce_TVALID : STD_LOGIC;
    signal ip_handler_duplicate_U0_m_axis_roce_TKEEP : STD_LOGIC_VECTOR (63 downto 0);
    signal ip_handler_duplicate_U0_m_axis_roce_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal ethDataFifo_V_data_V_dout : STD_LOGIC_VECTOR (511 downto 0);
    signal ethDataFifo_V_data_V_empty_n : STD_LOGIC;
    signal ethDataFifo_V_keep_V_full_n : STD_LOGIC;
    signal ethDataFifo_V_keep_V_dout : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal ipv4ShiftFifo_V_data_dout : STD_LOGIC_VECTOR (511 downto 0);
    signal ipv4ShiftFifo_V_data_empty_n : STD_LOGIC;
    signal ipv4ShiftFifo_V_keep_full_n : STD_LOGIC;
    signal ipv4ShiftFifo_V_keep_dout : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal ipv6ShiftFifo_V_data_dout : STD_LOGIC_VECTOR (511 downto 0);
    signal ipv6ShiftFifo_V_data_empty_n : STD_LOGIC;
    signal ipv6ShiftFifo_V_keep_full_n : STD_LOGIC;
    signal ipv6ShiftFifo_V_keep_dout : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal ipDataFifo_V_dout : STD_LOGIC_VECTOR (576 downto 0);
    signal ipDataFifo_V_empty_n : STD_LOGIC;
    signal ipv6DataFifo_V_data_s_full_n : STD_LOGIC;
    signal ipv6DataFifo_V_data_s_dout : STD_LOGIC_VECTOR (511 downto 0);
    signal ipv6DataFifo_V_data_s_empty_n : STD_LOGIC;
    signal ipv6DataFifo_V_keep_s_full_n : STD_LOGIC;
    signal ipv6DataFifo_V_keep_s_dout : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal ipDataMetaFifo_V_dat_dout : STD_LOGIC_VECTOR (511 downto 0);
    signal ipDataMetaFifo_V_dat_empty_n : STD_LOGIC;
    signal ipDataMetaFifo_V_kee_full_n : STD_LOGIC;
    signal ipDataMetaFifo_V_kee_dout : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal ipDataCheckFifo_V_dout : STD_LOGIC_VECTOR (576 downto 0);
    signal ipDataCheckFifo_V_empty_n : STD_LOGIC;
    signal iph_subSumsFifoOut_V_full_n : STD_LOGIC;
    signal iph_subSumsFifoOut_V_dout : STD_LOGIC_VECTOR (543 downto 0);
    ...
    signal ipDataDropFifo_V_dout : STD_LOGIC_VECTOR (576 downto 0);
    signal ipDataDropFifo_V_empty_n : STD_LOGIC;
    signal ipDataCutFifo_V_full_n : STD_LOGIC;
    signal ipDataCutFifo_V_dout : STD_LOGIC_VECTOR (576 downto 0);
    signal ipDataCutFifo_V_empty_n : STD_LOGIC;
    signal udpDataFifo_V_full_n : STD_LOGIC;
    signal udpDataFifo_V_dout : STD_LOGIC_VECTOR (576 downto 0);
    ...
    component ip_handler_rshiftWor_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component ip_handler_rshiftWor IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        ipv6ShiftFifo_V_data_dout : IN STD_LOGIC_VECTOR (511 downto 0);
        ipv6ShiftFifo_V_data_empty_n : IN STD_LOGIC;
        ipv6ShiftFifo_V_data_read : OUT STD_LOGIC;
        ipv6ShiftFifo_V_keep_dout : IN STD_LOGIC_VECTOR (63 downto 0);
        ...
        ipv6DataFifo_V_data_s_din : OUT STD_LOGIC_VECTOR (511 downto 0);
        ipv6DataFifo_V_data_s_full_n : IN STD_LOGIC;
        ipv6DataFifo_V_data_s_write : OUT STD_LOGIC;
        ipv6DataFifo_V_keep_s_din : OUT STD_LOGIC_VECTOR (63 downto 0);
    ...
    component extract_ip_meta_512_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component ip_handler_compute_i IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component ip_handler_check_ipv IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    port (
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        ipDataCheckFifo_V_dout : IN STD_LOGIC_VECTOR (576 downto 0);
        ...
        ipDataDropFifo_V_din : OUT STD_LOGIC_VECTOR (576 downto 0);
    ...
    port (
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        ipDataDropFifo_V_dout : IN STD_LOGIC_VECTOR (576 downto 0);
        ipDataDropFifo_V_empty_n : IN STD_LOGIC;
        ipDataDropFifo_V_read : OUT STD_LOGIC;
        ipDataCutFifo_V_din : OUT STD_LOGIC_VECTOR (576 downto 0);
    ...
    component ip_handler_duplicate IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    ...
    ip_handler_rshiftWor_1_U0 : component ip_handler_rshiftWor_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    ip_handler_rshiftWor_U0 : component ip_handler_rshiftWor
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    extract_ip_meta_512_U0 : component extract_ip_meta_512_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    ip_handler_compute_i_U0 : component ip_handler_compute_i
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    ip_handler_check_ipv_U0 : component ip_handler_check_ipv
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    cut_length_U0 : component cut_length
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    ip_handler_duplicate_U0 : component ip_handler_duplicate
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    ethDataFifo_V_data_V_U : component fifo_w512_d4_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ethDataFifo_V_keep_V_U : component fifo_w64_d4_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ipv4ShiftFifo_V_data_U : component fifo_w512_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ipv4ShiftFifo_V_keep_U : component fifo_w64_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ipv6ShiftFifo_V_data_U : component fifo_w512_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ipv6ShiftFifo_V_keep_U : component fifo_w64_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ipDataFifo_V_U : component fifo_w577_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ipv6DataFifo_V_data_s_U : component fifo_w512_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ipv6DataFifo_V_keep_s_U : component fifo_w64_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ipDataMetaFifo_V_dat_U : component fifo_w512_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ipDataMetaFifo_V_kee_U : component fifo_w64_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ipDataCheckFifo_V_U : component fifo_w577_d64_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    iph_subSumsFifoOut_V_U : component fifo_w544_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ipDataDropFifo_V_U : component fifo_w577_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ipDataCutFifo_V_U : component fifo_w577_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    udpDataFifo_V_U : component fifo_w577_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ip_handler_check_ipv_U0_ap_continue <= ap_const_logic_1;
    ip_handler_check_ipv_U0_ap_start <= ap_const_logic_1;
    ip_handler_compute_i_U0_ap_continue <= ap_const_logic_1;
    ip_handler_compute_i_U0_ap_start <= ap_const_logic_1;
    ip_handler_duplicate_U0_ap_continue <= ap_const_logic_1;
    ip_handler_duplicate_U0_ap_start <= ap_const_logic_1;
    ip_handler_rshiftWor_1_U0_ap_continue <= ap_const_logic_1;
    ip_handler_rshiftWor_1_U0_ap_start <= ap_const_logic_1;
    ip_handler_rshiftWor_U0_ap_continue <= ap_const_logic_1;
    ip_handler_rshiftWor_U0_ap_start <= ap_const_logic_1;
