...
architecture behav of ip_invalid_dropper is 
    ...
    signal tmp34_reg_171 : STD_LOGIC_VECTOR (576 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_predicate_op11_read_state1 = ap_const_boolean_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                tmp34_reg_171 <= ipDataCheckFifo_V_dout;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
                ap_condition_211 <= ((ap_const_boolean_0 = ap_block_pp0_stage0_01001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0));
    end process;


    ap_condition_67_assign_proc : process(tmp_nbreadreq_fu_70_p3, tmp_5_nbreadreq_fu_78_p3, iid_state)
    begin
                ap_condition_67 <= ((tmp_5_nbreadreq_fu_78_p3 = ap_const_lv1_1) and (tmp_nbreadreq_fu_70_p3 = ap_const_lv1_1) and (iid_state = ap_const_lv2_0));
    end process;
    ...
    ap_phi_mux_storemerge_i_phi_fu_117_p4_assign_proc : process(and_ln195_fu_143_p2, ap_phi_reg_pp0_iter0_storemerge_i_reg_114, ap_condition_67)
    begin
    ...
    grp_fu_125_p3 <= ipDataCheckFifo_V_dout(576 downto 576);
    ...
    ipDataDropFifo_V_din <= tmp34_reg_171;
    ...
    ipv4ValidFifo_V_din_assign_proc : process(ap_predicate_op42_write_state2, ap_predicate_op43_write_state2, ap_condition_211)
    begin
