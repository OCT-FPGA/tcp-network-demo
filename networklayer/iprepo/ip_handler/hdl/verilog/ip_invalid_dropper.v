...
output   ap_idle;
output   ap_ready;
input  [576:0] ipDataCheckFifo_V_dout;
...
output  [576:0] ipDataDropFifo_V_din;
...
always @ (*) begin
    ap_condition_211 = ((1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0));
end

always @ (*) begin
    ap_condition_67 = ((tmp_5_nbreadreq_fu_78_p3 == 1'd1) & (tmp_nbreadreq_fu_70_p3 == 1'd1) & (iid_state == 2'd0));
end
...
assign grp_fu_125_p3 = ipDataCheckFifo_V_dout[32'd576];

assign grp_nbreadreq_fu_56_p3 = ipDataCheckFifo_V_empty_n;

assign ipDataDropFifo_V_din = tmp34_reg_171;
