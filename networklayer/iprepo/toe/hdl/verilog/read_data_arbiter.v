...
output   ap_idle;
output   ap_ready;
input  [511:0] txApp2txEng_data_str_3_dout;
input   txApp2txEng_data_str_3_empty_n;
output   txApp2txEng_data_str_3_read;
input  [63:0] txApp2txEng_data_str_5_dout;
...
input  [576:0] txBufferReadDataStit_1_dout;
...
output  [576:0] txEng_tcpPkgBuffer0_s_9_din;
...
reg[576:0] txEng_tcpPkgBuffer0_s_9_din;
...
wire   [0:0] tmp_372_nbreadreq_fu_58_p5;
reg    ap_predicate_op7_read_state1;
wire   [0:0] tmp_371_nbreadreq_fu_80_p3;
...
reg   [0:0] tmp_372_reg_171;
reg    ap_predicate_op31_write_state2;
reg   [0:0] tmp_371_reg_190;
...
reg   [511:0] tmp_data_V_reg_175;
reg   [63:0] tmp_keep_V_reg_180;
wire   [0:0] tmp_last_V_7_fu_133_p1;
reg   [0:0] tmp_last_V_7_reg_185;
reg   [576:0] tmp60_reg_194;
wire   [0:0] tmp_last_V_fu_137_p3;
reg    ap_block_pp0_stage0_subdone;
wire   [1:0] select_ln1416_fu_145_p3;
wire   [576:0] tmp_2_fu_159_p4;
...
always @ (posedge ap_clk) begin
    ...
    end else if ((((tmp_371_nbreadreq_fu_80_p3 == 1'd1) & (tmp_last_V_fu_137_p3 == 1'd1) & (tps_state_V == 2'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)) | ((tmp_last_V_7_fu_133_p1 == 1'd1) & (tmp_372_nbreadreq_fu_58_p5 == 1'd1) & (tps_state_V == 2'd2) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
        tps_state_V <= 2'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((tmp_372_nbreadreq_fu_58_p5 == 1'd1) & (tps_state_V == 2'd2) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    ap_predicate_op14_read_state1 = ((tmp_371_nbreadreq_fu_80_p3 == 1'd1) & (tps_state_V == 2'd1));
end
...
always @ (*) begin
    ap_predicate_op31_write_state2 = ((tmp_372_reg_171 == 1'd1) & (tps_state_V_load_reg_167 == 2'd2));
end

always @ (*) begin
    ap_predicate_op36_write_state2 = ((tps_state_V_load_reg_167 == 2'd1) & (tmp_371_reg_190 == 1'd1));
end

always @ (*) begin
    ap_predicate_op7_read_state1 = ((tmp_372_nbreadreq_fu_58_p5 == 1'd1) & (tps_state_V == 2'd2));
end
...
assign select_ln1416_fu_145_p3 = ((txEng_isDDRbypass_V_dout[0:0] === 1'b1) ? 2'd2 : 2'd1);

assign tmp_2_fu_159_p4 = {{{tmp_last_V_7_reg_185}, {tmp_keep_V_reg_180}}, {tmp_data_V_reg_175}};

assign tmp_371_nbreadreq_fu_80_p3 = txBufferReadDataStit_1_empty_n;

assign tmp_372_nbreadreq_fu_58_p5 = (txApp2txEng_data_str_6_empty_n & txApp2txEng_data_str_5_empty_n & txApp2txEng_data_str_3_empty_n);

assign tmp_last_V_7_fu_133_p1 = txApp2txEng_data_str_6_dout;

assign tmp_last_V_fu_137_p3 = txBufferReadDataStit_1_dout[32'd576];
