...
always @ (*) begin
    ap_predicate_op14_write_state3 = ((tmp_reg_63_pp0_iter1_reg == 1'd0) & (tmp_274_reg_72 == 1'd1));
end

always @ (*) begin
    ap_predicate_op9_read_state2 = ((tmp_reg_63 == 1'd0) & (tmp_274_nbreadreq_fu_42_p3 == 1'd1));
end

assign tmp_274_nbreadreq_fu_42_p3 = rtTimer2stateTable_r_1_empty_n;
