...
output   ap_idle;
output   ap_ready;
input  [511:0] rxEng_pseudoHeaderFi_3_dout;
input   rxEng_pseudoHeaderFi_3_empty_n;
output   rxEng_pseudoHeaderFi_3_read;
input  [63:0] rxEng_pseudoHeaderFi_5_dout;
...
input  [511:0] rxEng_dataBuffer5_V_1_dout;
input   rxEng_dataBuffer5_V_1_empty_n;
output   rxEng_dataBuffer5_V_1_read;
input  [63:0] rxEng_dataBuffer5_V_2_dout;
...
output  [576:0] rxEng_dataBuffer1_V_din;
...
reg[576:0] rxEng_dataBuffer1_V_din;
...
wire   [0:0] tmp_404_nbreadreq_fu_54_p5;
...
reg   [511:0] tmp_data_V_reg_225;
reg   [63:0] tmp_keep_V_reg_230;
wire   [0:0] tmp_last_V_fu_130_p1;
reg   [63:0] tmp_keep_V_12_reg_248;
wire   [0:0] tmp_last_V_10_fu_160_p1;
reg   [0:0] tmp_last_V_10_reg_253;
wire   [511:0] p_Result_s_fu_172_p5;
wire   [0:0] firstPayload_load_load_fu_118_p1;
reg    ap_block_pp0_stage0_subdone;
wire   [511:0] ap_phi_reg_pp0_iter0_tmp_data_V_11_reg_105;
reg   [511:0] ap_phi_reg_pp0_iter1_tmp_data_V_11_reg_105;
wire   [576:0] tmp48_fu_196_p4;
reg    ap_block_pp0_stage0_01001;
wire   [576:0] tmp_1_fu_205_p4;
wire   [95:0] trunc_ln647_fu_168_p1;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((tmp_404_nbreadreq_fu_54_p5 == 1'd1) & (state_2 == 1'd0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_404_nbreadreq_fu_54_p5 == 1'd1) & (state_2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    ap_condition_182 = ((tmp_last_V_fu_130_p1 == 1'd1) & (tmp_404_nbreadreq_fu_54_p5 == 1'd1) & (state_2 == 1'd0));
end
...
assign ap_phi_reg_pp0_iter0_tmp_data_V_11_reg_105 = 'bx;
...
always @ (*) begin
    ap_predicate_op38_write_state2 = ((tmp_404_reg_221 == 1'd1) & (tmp_last_V_reg_235 == 1'd0) & (state_2_load_reg_214 == 1'd0));
end
...
always @ (*) begin
    ap_predicate_op8_read_state1 = ((tmp_404_nbreadreq_fu_54_p5 == 1'd1) & (state_2 == 1'd0));
end
...
assign p_Result_s_fu_172_p5 = {{rxEng_dataBuffer5_V_1_dout[511:96]}, {trunc_ln647_fu_168_p1}};

assign tmp48_fu_196_p4 = {{{{1'd0}, {tmp_keep_V_reg_230}}}, {tmp_data_V_reg_225}};

assign tmp_1_fu_205_p4 = {{{tmp_last_V_10_reg_253}, {tmp_keep_V_12_reg_248}}, {ap_phi_reg_pp0_iter1_tmp_data_V_11_reg_105}};

assign tmp_404_nbreadreq_fu_54_p5 = (rxEng_pseudoHeaderFi_6_empty_n & rxEng_pseudoHeaderFi_5_empty_n & rxEng_pseudoHeaderFi_3_empty_n);
...
assign trunc_ln647_fu_168_p1 = prevWord_data_V_11[95:0];
