...
output  [55:0] probeTimer2eventEng_1_din;
...
wire   [0:0] tmp_401_nbreadreq_fu_88_p3;
...
reg   [0:0] tmp_402_reg_352;
wire   [0:0] tmp_403_nbwritereq_fu_108_p3;
...
wire   [63:0] zext_ln544_19_fu_259_p1;
...
wire   [0:0] icmp_ln879_44_fu_279_p2;
...
always @ (posedge ap_clk) begin
    if (((tmp_reg_329 == 1'd0) & (pt_WaitForWrite_load_reg_320 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        probeTimerTable_addr_1_reg_340 <= zext_ln544_19_fu_259_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if (((tmp_401_nbreadreq_fu_88_p3 == 1'd0) & (tmp_nbreadreq_fu_80_p3 == 1'd0) & (pt_WaitForWrite == 1'd0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_reg_329_pp0_iter1_reg == 1'd0) & (pt_WaitForWrite_load_reg_320_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmp_402_reg_352 <= probeTimerTable_q0[32'd32];
    end
end
...
always @ (*) begin
    if (((tmp_nbreadreq_fu_80_p3 == 1'd0) & (pt_WaitForWrite == 1'd0))) begin
        if ((tmp_401_nbreadreq_fu_88_p3 == 1'd1)) begin
            ap_phi_mux_tmp_sessionID_V_phi_fu_153_p4 = rxEng2timer_clearPro_1_dout;
        end else if ((tmp_401_nbreadreq_fu_88_p3 == 1'd0)) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_202)) begin
        if (((pt_WaitForWrite_load_reg_320 == 1'd1) & (icmp_ln883_reg_336 == 1'd0))) begin
            ...
            probeTimerTable_address0 = zext_ln544_19_fu_259_p1;
        end else begin
...
always @ (*) begin
    if ((((or_ln101_fu_285_p2 == 1'd1) & (tmp_403_nbwritereq_fu_108_p3 == 1'd1) & (tmp_402_reg_352 == 1'd1) & (tmp_reg_329_pp0_iter2_reg == 1'd0) & (pt_WaitForWrite_load_reg_320_pp0_iter2_reg == 1'd0) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001)) | ((tmp_403_nbwritereq_fu_108_p3 == 1'd1) & (tmp_402_reg_352 == 1'd1) & (or_ln101_fu_285_p2 == 1'd0) & (tmp_reg_329_pp0_iter2_reg == 1'd0) & (pt_WaitForWrite_load_reg_320_pp0_iter2_reg == 1'd0) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
...
always @ (*) begin
    ap_condition_188 = ((tmp_401_nbreadreq_fu_88_p3 == 1'd0) & (tmp_nbreadreq_fu_80_p3 == 1'd0) & (pt_WaitForWrite == 1'd0));
end

always @ (*) begin
    ap_condition_202 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0));
end

always @ (*) begin
    ap_condition_373 = ((tmp_403_nbwritereq_fu_108_p3 == 1'd1) & (tmp_402_reg_352 == 1'd1) & (tmp_reg_329_pp0_iter2_reg == 1'd0) & (pt_WaitForWrite_load_reg_320_pp0_iter2_reg == 1'd0) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b0 == ap_block_pp0_stage0));
end

always @ (*) begin
    ap_condition_53 = ((tmp_401_nbreadreq_fu_88_p3 == 1'd1) & (tmp_nbreadreq_fu_80_p3 == 1'd0) & (pt_WaitForWrite == 1'd0));
end
...
always @ (*) begin
    ap_predicate_op19_read_state1 = ((tmp_401_nbreadreq_fu_88_p3 == 1'd1) & (tmp_nbreadreq_fu_80_p3 == 1'd0) & (pt_WaitForWrite == 1'd0));
end
...
always @ (*) begin
    ap_predicate_op54_store_state4 = ((tmp_403_nbwritereq_fu_108_p3 == 1'd1) & (tmp_402_reg_352 == 1'd1) & (or_ln101_fu_285_p2 == 1'd0) & (tmp_reg_329_pp0_iter2_reg == 1'd0) & (pt_WaitForWrite_load_reg_320_pp0_iter2_reg == 1'd0));
end

always @ (*) begin
    ap_predicate_op56_store_state4 = ((or_ln101_fu_285_p2 == 1'd1) & (tmp_403_nbwritereq_fu_108_p3 == 1'd1) & (tmp_402_reg_352 == 1'd1) & (tmp_reg_329_pp0_iter2_reg == 1'd0) & (pt_WaitForWrite_load_reg_320_pp0_iter2_reg == 1'd0));
end

always @ (*) begin
    ap_predicate_op58_write_state4 = ((or_ln101_fu_285_p2 == 1'd1) & (tmp_403_nbwritereq_fu_108_p3 == 1'd1) & (tmp_402_reg_352 == 1'd1) & (tmp_reg_329_pp0_iter2_reg == 1'd0) & (pt_WaitForWrite_load_reg_320_pp0_iter2_reg == 1'd0));
end

assign icmp_ln879_44_fu_279_p2 = ((trunc_ln879_fu_276_p1 == 32'd0) ? 1'b1 : 1'b0);
...
assign or_ln101_fu_285_p2 = (icmp_ln879_44_fu_279_p2 | ap_phi_reg_pp0_iter3_fastResume_0_i_reg_161);

assign probeTimer2eventEng_1_din = {{{{37'd0}, {tmp_sessionID_V_reg_150_pp0_iter2_reg}}}, {3'd1}};
...
assign tmp_401_nbreadreq_fu_88_p3 = rxEng2timer_clearPro_1_empty_n;

assign tmp_403_nbwritereq_fu_108_p3 = probeTimer2eventEng_1_full_n;
...
assign zext_ln544_19_fu_259_p1 = tmp_sessionID_V_reg_150;
