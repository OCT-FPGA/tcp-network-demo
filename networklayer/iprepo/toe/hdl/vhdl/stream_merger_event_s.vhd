...
architecture behav of stream_merger_event_s is 
    ...
    signal tmp78_reg_67 : STD_LOGIC_VECTOR (55 downto 0);
    signal tmp78_reg_67_pp0_iter1_reg : STD_LOGIC_VECTOR (55 downto 0);
    signal tmp_2_reg_76 : STD_LOGIC_VECTOR (55 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_nbreadreq_fu_28_p3 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp78_reg_67 <= rtTimer2eventEng_set_1_dout;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp78_reg_67_pp0_iter1_reg <= tmp78_reg_67;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_reg_63 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_273_reg_72 <= tmp_273_nbreadreq_fu_42_p3;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_predicate_op14_write_state3_assign_proc : process(tmp_reg_63_pp0_iter1_reg, tmp_273_reg_72)
    begin
                ap_predicate_op14_write_state3 <= ((tmp_reg_63_pp0_iter1_reg = ap_const_lv1_0) and (tmp_273_reg_72 = ap_const_lv1_1));
    end process;


    ap_predicate_op9_read_state2_assign_proc : process(tmp_reg_63, tmp_273_nbreadreq_fu_42_p3)
    begin
                ap_predicate_op9_read_state2 <= ((tmp_reg_63 = ap_const_lv1_0) and (tmp_273_nbreadreq_fu_42_p3 = ap_const_lv1_1));
    end process;
    ...
    timer2eventEng_setEv_1_din_assign_proc : process(ap_enable_reg_pp0_iter2, tmp_reg_63_pp0_iter1_reg, ap_predicate_op14_write_state3, tmp78_reg_67_pp0_iter1_reg, tmp_2_reg_76, ap_block_pp0_stage0_01001)
    begin
        if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_01001))) then
            if ((tmp_reg_63_pp0_iter1_reg = ap_const_lv1_1)) then 
                timer2eventEng_setEv_1_din <= tmp78_reg_67_pp0_iter1_reg;
            elsif ((ap_predicate_op14_write_state3 = ap_const_boolean_1)) then 
                timer2eventEng_setEv_1_din <= tmp_2_reg_76;
            else 
                timer2eventEng_setEv_1_din <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
            end if;
        else 
            timer2eventEng_setEv_1_din <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
        end if; 
    ...
    tmp_273_nbreadreq_fu_42_p3 <= (0=>(probeTimer2eventEng_1_empty_n), others=>'-');
