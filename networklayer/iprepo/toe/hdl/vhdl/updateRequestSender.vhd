...
architecture behav of updateRequestSender is 
    ...
    signal regslice_both_sessionUpdate_req_V_U_apdone_blk : STD_LOGIC;
    ...
    signal sext_ln182_1_fu_223_p1 : STD_LOGIC_VECTOR (87 downto 0);
    signal sext_ln182_fu_238_p1 : STD_LOGIC_VECTOR (87 downto 0);
    ...
    signal sessionUpdate_req_V_TDATA_int : STD_LOGIC_VECTOR (87 downto 0);
    signal sessionUpdate_req_V_TVALID_int : STD_LOGIC;
    signal sessionUpdate_req_V_TREADY_int : STD_LOGIC;
    signal regslice_both_sessionUpdate_req_V_U_vld_out : STD_LOGIC;
...
begin
    regslice_both_sessionUpdate_req_V_U : component regslice_both
    generic map (
        DataWidth => 88)
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        data_in => sessionUpdate_req_V_TDATA_int,
        vld_in => sessionUpdate_req_V_TVALID_int,
        ack_in => sessionUpdate_req_V_TREADY_int,
        data_out => sessionUpdate_req_V_TDATA,
        vld_out => regslice_both_sessionUpdate_req_V_U_vld_out,
        ack_out => sessionUpdate_req_V_TREADY,
        apdone_blk => regslice_both_sessionUpdate_req_V_U_apdone_blk);
    ...
    ap_block_state3_io_assign_proc : process(tmp_reg_273_pp0_iter1_reg, ap_predicate_op26_write_state3, sessionUpdate_req_V_TREADY_int)
    begin
                ap_block_state3_io <= (((tmp_reg_273_pp0_iter1_reg = ap_const_lv1_1) and (sessionUpdate_req_V_TREADY_int = ap_const_logic_0)) or ((sessionUpdate_req_V_TREADY_int = ap_const_logic_0) and (ap_predicate_op26_write_state3 = ap_const_boolean_1)));
    end process;
    ...
    ap_block_state4_io_assign_proc : process(tmp_reg_273_pp0_iter2_reg, ap_predicate_op47_write_state4, sessionUpdate_req_V_TREADY_int)
    begin
                ap_block_state4_io <= (((tmp_reg_273_pp0_iter2_reg = ap_const_lv1_1) and (sessionUpdate_req_V_TREADY_int = ap_const_logic_0)) or ((sessionUpdate_req_V_TREADY_int = ap_const_logic_0) and (ap_predicate_op47_write_state4 = ap_const_boolean_1)));
    end process;


    ap_block_state4_pp0_stage0_iter3_assign_proc : process(regslice_both_sessionUpdate_req_V_U_apdone_blk)
    begin
                ap_block_state4_pp0_stage0_iter3 <= (regslice_both_sessionUpdate_req_V_U_apdone_blk = ap_const_logic_1);
    end process;
    ...
    begin
        if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (tmp_nbreadreq_fu_72_p8 = ap_const_lv1_1) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    sessionUpdate_req_V_TDATA_blk_n_assign_proc : process(ap_enable_reg_pp0_iter2, ap_enable_reg_pp0_iter3, tmp_reg_273_pp0_iter1_reg, ap_predicate_op26_write_state3, tmp_reg_273_pp0_iter2_reg, ap_predicate_op47_write_state4, ap_block_pp0_stage0, sessionUpdate_req_V_TREADY_int)
    begin
        if ((((tmp_reg_273_pp0_iter2_reg = ap_const_lv1_1) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0)) or ((ap_enable_reg_pp0_iter3 = ap_const_logic_1) and (ap_predicate_op47_write_state4 = ap_const_boolean_1) and (ap_const_boolean_0 = ap_block_pp0_stage0)) or ((tmp_reg_273_pp0_iter1_reg = ap_const_lv1_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0)) or ((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_predicate_op26_write_state3 = ap_const_boolean_1) and (ap_const_boolean_0 = ap_block_pp0_stage0)))) then 
            sessionUpdate_req_V_TDATA_blk_n <= sessionUpdate_req_V_TREADY_int;
        else 
    ...
    sessionUpdate_req_V_TDATA_int_assign_proc : process(ap_enable_reg_pp0_iter2, tmp_reg_273_pp0_iter1_reg, ap_predicate_op26_write_state3, sext_ln182_1_fu_223_p1, sext_ln182_fu_238_p1, ap_block_pp0_stage0_01001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_01001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then
            if ((tmp_reg_273_pp0_iter1_reg = ap_const_lv1_1)) then 
                sessionUpdate_req_V_TDATA_int <= sext_ln182_fu_238_p1;
            elsif ((ap_predicate_op26_write_state3 = ap_const_boolean_1)) then 
                sessionUpdate_req_V_TDATA_int <= sext_ln182_1_fu_223_p1;
            else 
                sessionUpdate_req_V_TDATA_int <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
            end if;
        else 
            sessionUpdate_req_V_TDATA_int <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
        end if; 
    ...
    sessionUpdate_req_V_TVALID <= regslice_both_sessionUpdate_req_V_U_vld_out;

    sessionUpdate_req_V_TVALID_int_assign_proc : process(ap_enable_reg_pp0_iter2, tmp_reg_273_pp0_iter1_reg, ap_predicate_op26_write_state3, ap_block_pp0_stage0_11001)
    begin
        if ((((tmp_reg_273_pp0_iter1_reg = ap_const_lv1_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001)) or ((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_predicate_op26_write_state3 = ap_const_boolean_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001)))) then 
            sessionUpdate_req_V_TVALID_int <= ap_const_logic_1;
        else 
            sessionUpdate_req_V_TVALID_int <= ap_const_logic_0;
        end if; 
    end process;

        sext_ln182_1_fu_223_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_11_fu_213_p7),88));

        sext_ln182_fu_238_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp13_fu_228_p7),88));
