...
architecture behav of txEventMerger is 
    ...
    signal tmp114_reg_116 : STD_LOGIC_VECTOR (55 downto 0);
    signal tmp114_reg_116_pp0_iter1_reg : STD_LOGIC_VECTOR (55 downto 0);
    signal tmp_2_reg_125 : STD_LOGIC_VECTOR (55 downto 0);
    ...
    signal tmp_19_i_fu_94_p4 : STD_LOGIC_VECTOR (52 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_reg_112 = ap_const_lv1_0) and (tmp_21_nbreadreq_fu_56_p3 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
    ...
    ap_predicate_op18_write_state3_assign_proc : process(tmp_reg_112_pp0_iter1_reg, tmp_21_reg_121)
    begin
                ap_predicate_op18_write_state3 <= ((tmp_reg_112_pp0_iter1_reg = ap_const_lv1_0) and (tmp_21_reg_121 = ap_const_lv1_1));
    end process;


    ap_predicate_op21_write_state3_assign_proc : process(tmp_reg_112_pp0_iter1_reg, tmp_21_reg_121, icmp_ln54_reg_131)
    begin
                ap_predicate_op21_write_state3 <= ((tmp_reg_112_pp0_iter1_reg = ap_const_lv1_0) and (icmp_ln54_reg_131 = ap_const_lv1_1) and (tmp_21_reg_121 = ap_const_lv1_1));
    end process;


    ap_predicate_op9_read_state2_assign_proc : process(tmp_reg_112, tmp_21_nbreadreq_fu_56_p3)
    begin
                ap_predicate_op9_read_state2 <= ((tmp_reg_112 = ap_const_lv1_0) and (tmp_21_nbreadreq_fu_56_p3 = ap_const_lv1_1));
    end process;
    ...
    tmp_19_i_fu_94_p4 <= tmp_2_reg_125(55 downto 3);
    tmp_21_nbreadreq_fu_56_p3 <= (0=>(txAppStream2event_me_1_empty_n), others=>'-');
    ...
    txApp_txEventCache_V_din <= (tmp_19_i_fu_94_p4 & ap_const_lv3_0);
