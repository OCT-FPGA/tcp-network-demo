...
architecture behav of stream_merger is 
    ...
    signal tmp_275_nbreadreq_fu_48_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_275_reg_86 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_275_reg_86_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp40_reg_81 : STD_LOGIC_VECTOR (80 downto 0);
    signal tmp40_reg_81_pp0_iter1_reg : STD_LOGIC_VECTOR (80 downto 0);
    signal tmp_2_reg_90 : STD_LOGIC_VECTOR (80 downto 0);
    signal sext_ln182_3_fu_69_p1 : STD_LOGIC_VECTOR (87 downto 0);
    signal sext_ln182_fu_73_p1 : STD_LOGIC_VECTOR (87 downto 0);
    ...
    signal out_V_TDATA_int : STD_LOGIC_VECTOR (87 downto 0);
...
begin
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_start, ap_done_reg, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter3, rxEng2rxApp_notifica_1_empty_n, tmp_nbreadreq_fu_34_p3, timer2rxApp_notifica_1_empty_n, ap_predicate_op10_read_state2, regslice_both_out_V_U_apdone_blk)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_done_reg = ap_const_logic_1) or ((regslice_both_out_V_U_apdone_blk = ap_const_logic_1) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1)) or ((timer2rxApp_notifica_1_empty_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_predicate_op10_read_state2 = ap_const_boolean_1)) or ((ap_start = ap_const_logic_1) and ((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or ((tmp_nbreadreq_fu_34_p3 = ap_const_lv1_1) and (rxEng2rxApp_notifica_1_empty_n = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_start, ap_done_reg, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, ap_enable_reg_pp0_iter3, rxEng2rxApp_notifica_1_empty_n, tmp_nbreadreq_fu_34_p3, timer2rxApp_notifica_1_empty_n, ap_predicate_op10_read_state2, ap_block_state3_io, regslice_both_out_V_U_apdone_blk, ap_block_state4_io)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_1 = ap_block_state3_io)) or ((timer2rxApp_notifica_1_empty_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_predicate_op10_read_state2 = ap_const_boolean_1)) or ((ap_start = ap_const_logic_1) and ((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or ((tmp_nbreadreq_fu_34_p3 = ap_const_lv1_1) and (rxEng2rxApp_notifica_1_empty_n = ap_const_logic_0)))) or ((ap_enable_reg_pp0_iter3 = ap_const_logic_1) and ((regslice_both_out_V_U_apdone_blk = ap_const_logic_1) or (ap_const_boolean_1 = ap_block_state4_io))));
    end process;
    ...
    ap_block_state3_io_assign_proc : process(tmp_reg_77_pp0_iter1_reg, ap_predicate_op12_write_state3, out_V_TREADY_int)
    begin
                ap_block_state3_io <= (((tmp_reg_77_pp0_iter1_reg = ap_const_lv1_1) and (out_V_TREADY_int = ap_const_logic_0)) or ((out_V_TREADY_int = ap_const_logic_0) and (ap_predicate_op12_write_state3 = ap_const_boolean_1)));
    end process;

        ap_block_state3_pp0_stage0_iter2 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state4_io_assign_proc : process(tmp_reg_77_pp0_iter2_reg, ap_predicate_op19_write_state4, out_V_TREADY_int)
    begin
                ap_block_state4_io <= (((out_V_TREADY_int = ap_const_logic_0) and (ap_predicate_op19_write_state4 = ap_const_boolean_1)) or ((tmp_reg_77_pp0_iter2_reg = ap_const_lv1_1) and (out_V_TREADY_int = ap_const_logic_0)));
    end process;


    ap_block_state4_pp0_stage0_iter3_assign_proc : process(regslice_both_out_V_U_apdone_blk)
    begin
                ap_block_state4_pp0_stage0_iter3 <= (regslice_both_out_V_U_apdone_blk = ap_const_logic_1);
    end process;
    ...
    ap_predicate_op10_read_state2_assign_proc : process(tmp_reg_77, tmp_275_nbreadreq_fu_48_p3)
    begin
                ap_predicate_op10_read_state2 <= ((tmp_reg_77 = ap_const_lv1_0) and (tmp_275_nbreadreq_fu_48_p3 = ap_const_lv1_1));
    end process;


    ap_predicate_op12_write_state3_assign_proc : process(tmp_reg_77_pp0_iter1_reg, tmp_275_reg_86)
    begin
                ap_predicate_op12_write_state3 <= ((tmp_reg_77_pp0_iter1_reg = ap_const_lv1_0) and (tmp_275_reg_86 = ap_const_lv1_1));
    end process;


    ap_predicate_op19_write_state4_assign_proc : process(tmp_reg_77_pp0_iter2_reg, tmp_275_reg_86_pp0_iter2_reg)
    begin
                ap_predicate_op19_write_state4 <= ((tmp_reg_77_pp0_iter2_reg = ap_const_lv1_0) and (tmp_275_reg_86_pp0_iter2_reg = ap_const_lv1_1));
    end process;
    ...
    out_V_TDATA_blk_n_assign_proc : process(ap_enable_reg_pp0_iter2, ap_enable_reg_pp0_iter3, tmp_reg_77_pp0_iter1_reg, ap_predicate_op12_write_state3, tmp_reg_77_pp0_iter2_reg, ap_predicate_op19_write_state4, ap_block_pp0_stage0, out_V_TREADY_int)
    begin
        if ((((ap_enable_reg_pp0_iter3 = ap_const_logic_1) and (ap_predicate_op19_write_state4 = ap_const_boolean_1) and (ap_const_boolean_0 = ap_block_pp0_stage0)) or ((tmp_reg_77_pp0_iter1_reg = ap_const_lv1_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0)) or ((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_predicate_op12_write_state3 = ap_const_boolean_1) and (ap_const_boolean_0 = ap_block_pp0_stage0)) or ((tmp_reg_77_pp0_iter2_reg = ap_const_lv1_1) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0)))) then 
    ...
    out_V_TDATA_int_assign_proc : process(ap_enable_reg_pp0_iter2, tmp_reg_77_pp0_iter1_reg, ap_predicate_op12_write_state3, sext_ln182_3_fu_69_p1, sext_ln182_fu_73_p1, ap_block_pp0_stage0_01001)
    begin
        if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_01001))) then
            if ((tmp_reg_77_pp0_iter1_reg = ap_const_lv1_1)) then 
                ...
                out_V_TDATA_int <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
            end if;
        else 
            out_V_TDATA_int <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
        end if; 
    ...
    out_V_TVALID_int_assign_proc : process(ap_enable_reg_pp0_iter2, tmp_reg_77_pp0_iter1_reg, ap_predicate_op12_write_state3, ap_block_pp0_stage0_11001)
    begin
    ...
    begin
        ...
        sext_ln182_3_fu_69_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_2_reg_90),88));

        sext_ln182_fu_73_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp40_reg_81_pp0_iter1_reg),88));
    ...
    tmp_275_nbreadreq_fu_48_p3 <= (0=>(timer2rxApp_notifica_1_empty_n), others=>'-');
