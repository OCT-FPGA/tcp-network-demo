...
architecture behav of Block_proc2790 is 
    ...
    signal tmp_519_nbreadreq_fu_44_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_3_fu_72_p5 : STD_LOGIC_VECTOR (151 downto 0);
...
begin
    ...
    ap_predicate_op11_write_state1_assign_proc : process(tmp_nbreadreq_fu_36_p3, tmp_519_nbreadreq_fu_44_p3)
    begin
                ap_predicate_op11_write_state1 <= ((tmp_519_nbreadreq_fu_44_p3 = ap_const_lv1_1) and (tmp_nbreadreq_fu_36_p3 = ap_const_lv1_0));
    end process;


    ap_predicate_op9_read_state1_assign_proc : process(tmp_nbreadreq_fu_36_p3, tmp_519_nbreadreq_fu_44_p3)
    begin
                ap_predicate_op9_read_state1 <= ((tmp_519_nbreadreq_fu_44_p3 = ap_const_lv1_1) and (tmp_nbreadreq_fu_36_p3 = ap_const_lv1_0));
    end process;
    ...
    rxEng2eventEng_setEv_1_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, rxEng2eventEng_setEv_1_full_n, tmp_nbreadreq_fu_36_p3, tmp_519_nbreadreq_fu_44_p3)
    begin
        if (((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (tmp_519_nbreadreq_fu_44_p3 = ap_const_lv1_1) and (tmp_nbreadreq_fu_36_p3 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1)) or (not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (tmp_nbreadreq_fu_36_p3 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1)))) then 
    ...
    begin
        if ((ap_const_boolean_1 = ap_condition_74)) then
            if ((tmp_nbreadreq_fu_36_p3 = ap_const_lv1_1)) then 
                ...
                rxEng2eventEng_setEv_1_din <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
            end if;
        else 
            rxEng2eventEng_setEv_1_din <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
        end if; 
    ...
    rxEng_fsmEventFifo_V_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, rxEng_fsmEventFifo_V_empty_n, tmp_nbreadreq_fu_36_p3, tmp_519_nbreadreq_fu_44_p3)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (tmp_519_nbreadreq_fu_44_p3 = ap_const_lv1_1) and (tmp_nbreadreq_fu_36_p3 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_3_fu_72_p5 <= (ap_const_lv152_lc_1(151 downto 56) & rxEng_fsmEventFifo_V_dout);
    tmp_519_nbreadreq_fu_44_p3 <= (0=>(rxEng_fsmEventFifo_V_empty_n), others=>'-');
