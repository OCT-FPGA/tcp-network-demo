...
architecture behav of read_data_arbiter is 
    ...
    signal tmp_372_nbreadreq_fu_58_p5 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_predicate_op7_read_state1 : BOOLEAN;
    signal tmp_371_nbreadreq_fu_80_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_372_reg_171 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_predicate_op31_write_state2 : BOOLEAN;
    signal tmp_371_reg_190 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_data_V_reg_175 : STD_LOGIC_VECTOR (511 downto 0);
    signal tmp_keep_V_reg_180 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_last_V_7_fu_133_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_last_V_7_reg_185 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp60_reg_194 : STD_LOGIC_VECTOR (576 downto 0);
    signal tmp_last_V_fu_137_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal select_ln1416_fu_145_p3 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_2_fu_159_p4 : STD_LOGIC_VECTOR (576 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_nbreadreq_fu_94_p3 = ap_const_lv1_1) and (tps_state_V = ap_const_lv2_0) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                tps_state_V <= select_ln1416_fu_145_p3;
            elsif ((((tmp_371_nbreadreq_fu_80_p3 = ap_const_lv1_1) and (tmp_last_V_fu_137_p3 = ap_const_lv1_1) and (tps_state_V = ap_const_lv2_1) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001)) or ((tmp_last_V_7_fu_133_p1 = ap_const_lv1_1) and (tmp_372_nbreadreq_fu_58_p5 = ap_const_lv1_1) and (tps_state_V = ap_const_lv2_2) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_predicate_op14_read_state1 = ap_const_boolean_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                tmp60_reg_194 <= txBufferReadDataStit_1_dout;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tps_state_V = ap_const_lv2_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                tmp_371_reg_190 <= tmp_371_nbreadreq_fu_80_p3;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tps_state_V = ap_const_lv2_2) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                tmp_372_reg_171 <= tmp_372_nbreadreq_fu_58_p5;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_372_nbreadreq_fu_58_p5 = ap_const_lv1_1) and (tps_state_V = ap_const_lv2_2) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
    ...
    ap_predicate_op14_read_state1_assign_proc : process(tmp_371_nbreadreq_fu_80_p3, tps_state_V)
    begin
                ap_predicate_op14_read_state1 <= ((tmp_371_nbreadreq_fu_80_p3 = ap_const_lv1_1) and (tps_state_V = ap_const_lv2_1));
    end process;
    ...
    ap_predicate_op31_write_state2_assign_proc : process(tps_state_V_load_reg_167, tmp_372_reg_171)
    begin
                ap_predicate_op31_write_state2 <= ((tmp_372_reg_171 = ap_const_lv1_1) and (tps_state_V_load_reg_167 = ap_const_lv2_2));
    end process;


    ap_predicate_op36_write_state2_assign_proc : process(tps_state_V_load_reg_167, tmp_371_reg_190)
    begin
                ap_predicate_op36_write_state2 <= ((tps_state_V_load_reg_167 = ap_const_lv2_1) and (tmp_371_reg_190 = ap_const_lv1_1));
    end process;


    ap_predicate_op7_read_state1_assign_proc : process(tmp_372_nbreadreq_fu_58_p5, tps_state_V)
    begin
                ap_predicate_op7_read_state1 <= ((tmp_372_nbreadreq_fu_58_p5 = ap_const_lv1_1) and (tps_state_V = ap_const_lv2_2));
    end process;
    ...
    tmp_371_nbreadreq_fu_80_p3 <= (0=>(txBufferReadDataStit_1_empty_n), others=>'-');
    tmp_372_nbreadreq_fu_58_p5 <= (0=>(txApp2txEng_data_str_6_empty_n and txApp2txEng_data_str_5_empty_n and txApp2txEng_data_str_3_empty_n), others=>'-');
    tmp_last_V_7_fu_133_p1 <= txApp2txEng_data_str_6_dout;
    tmp_last_V_fu_137_p3 <= txBufferReadDataStit_1_dout(576 downto 576);
    ...
    txEng_tcpPkgBuffer0_s_9_din_assign_proc : process(ap_predicate_op31_write_state2, ap_predicate_op36_write_state2, tmp60_reg_194, tmp_2_fu_159_p4, ap_condition_191)
    begin
        if ((ap_const_boolean_1 = ap_condition_191)) then
            if ((ap_predicate_op36_write_state2 = ap_const_boolean_1)) then 
                txEng_tcpPkgBuffer0_s_9_din <= tmp60_reg_194;
            elsif ((ap_predicate_op31_write_state2 = ap_const_boolean_1)) then 
                txEng_tcpPkgBuffer0_s_9_din <= tmp_2_fu_159_p4;
            else 
                txEng_tcpPkgBuffer0_s_9_din <= "";
            end if;
        else 
            txEng_tcpPkgBuffer0_s_9_din <= "";
        end if; 
