...
architecture behav of udp_top is 
    ...
    "udp_top,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xcu280-fsvh2892-2L-e,HLS_INPUT_CLOCK=3.200000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=3.012000,HLS_SYN_LAT=5,HLS_SYN_TPT=1,HLS_SYN_MEM=58,HLS_SYN_DSP=0,HLS_SYN_FF=5651,HLS_SYN_LUT=3990,HLS_VERSION=2020_1}";
    ...
    signal process_udp_512_U0_rx_udp2shiftFifo_V_d_din : STD_LOGIC_VECTOR (511 downto 0);
    signal process_udp_512_U0_rx_udp2shiftFifo_V_d_write : STD_LOGIC;
    signal process_udp_512_U0_rx_udp2shiftFifo_V_k_din : STD_LOGIC_VECTOR (63 downto 0);
    signal process_udp_512_U0_rx_udp2shiftFifo_V_k_write : STD_LOGIC;
    signal process_udp_512_U0_rx_udp2shiftFifo_V_l_din : STD_LOGIC_VECTOR (0 downto 0);
    signal process_udp_512_U0_rx_udp2shiftFifo_V_l_write : STD_LOGIC;
    signal process_udp_512_U0_rx_udpMetaFifo_V_din : STD_LOGIC_VECTOR (48 downto 0);
    signal process_udp_512_U0_rx_udpMetaFifo_V_write : STD_LOGIC;
    ...
    signal udp_rshiftWordByOcte_U0_m_axis_rx_data_TDATA : STD_LOGIC_VECTOR (511 downto 0);
    signal udp_rshiftWordByOcte_U0_m_axis_rx_data_TVALID : STD_LOGIC;
    signal udp_rshiftWordByOcte_U0_m_axis_rx_data_TKEEP : STD_LOGIC_VECTOR (63 downto 0);
    signal udp_rshiftWordByOcte_U0_m_axis_rx_data_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal udp_lshiftWordByOcte_U0_s_axis_tx_data_TREADY : STD_LOGIC;
    ...
    signal generate_udp_512_U0_m_axis_tx_data_TDATA : STD_LOGIC_VECTOR (511 downto 0);
    signal generate_udp_512_U0_m_axis_tx_data_TVALID : STD_LOGIC;
    signal generate_udp_512_U0_m_axis_tx_data_TKEEP : STD_LOGIC_VECTOR (63 downto 0);
    signal generate_udp_512_U0_m_axis_tx_data_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component process_udp_512_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
...
begin
    process_udp_512_U0 : component process_udp_512_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
