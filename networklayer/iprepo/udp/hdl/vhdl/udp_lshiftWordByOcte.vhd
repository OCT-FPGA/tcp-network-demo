...
architecture behav of udp_lshiftWordByOcte is 
    ...
    constant ap_const_lv512_lc_2 : STD_LOGIC_VECTOR (511 downto 0) := "";
    ...
    signal p_Result_i_reg_331 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_fu_125_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_Result_i_36_reg_336 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal p_Result_4_fu_297_p3 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln647_2_fu_173_p1 : STD_LOGIC_VECTOR (55 downto 0);
    signal trunc_ln647_fu_163_p1 : STD_LOGIC_VECTOR (447 downto 0);
    signal p_Result_16_i_fu_195_p4 : STD_LOGIC_VECTOR (63 downto 0);
    signal p_Result_6_fu_177_p3 : STD_LOGIC_VECTOR (63 downto 0);
    signal p_Result_8_fu_213_p3 : STD_LOGIC_VECTOR (63 downto 0);
    signal p_Result_5_fu_167_p2 : STD_LOGIC_VECTOR (511 downto 0);
    signal p_Result_7_fu_205_p3 : STD_LOGIC_VECTOR (511 downto 0);
    signal p_Result_15_i_fu_185_p4 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ls_writeRemainder_lo_load_fu_134_p1 = ap_const_lv1_1) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                p_Result_i_36_reg_336 <= prevWord_keep_V_1(63 downto 56);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ls_writeRemainder_lo_load_fu_134_p1 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                p_Result_i_reg_331 <= prevWord_data_V(511 downto 448);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    grp_fu_125_p4 <= prevWord_keep_V_1(63 downto 56);
    io_acc_block_signal_op40 <= (tx_shift2udpFifo_V_l_full_n and tx_shift2udpFifo_V_k_full_n and tx_shift2udpFifo_V_d_full_n);
    io_acc_block_signal_op47 <= (tx_shift2udpFifo_V_l_full_n and tx_shift2udpFifo_V_k_full_n and tx_shift2udpFifo_V_d_full_n);
    ls_writeRemainder_lo_load_fu_134_p1 <= ls_writeRemainder;
    p_Result_15_i_fu_185_p4 <= s_axis_tx_data_TKEEP(63 downto 56);
    p_Result_16_i_fu_195_p4 <= prevWord_data_V(511 downto 448);
    p_Result_4_fu_297_p3 <= (ap_const_lv56_0 & p_Result_i_36_reg_336);
    p_Result_5_fu_167_p2 <= std_logic_vector(shift_left(unsigned(s_axis_tx_data_TDATA),to_integer(unsigned('0' & ap_const_lv512_lc_2(31-1 downto 0)))));
    p_Result_6_fu_177_p3 <= (trunc_ln647_2_fu_173_p1 & ap_const_lv8_FF);
    p_Result_7_fu_205_p3 <= (trunc_ln647_fu_163_p1 & p_Result_16_i_fu_195_p4);
    p_Result_8_fu_213_p3 <= (trunc_ln647_2_fu_173_p1 & grp_fu_125_p4);
    p_Result_s_fu_289_p3 <= (ap_const_lv448_lc_1 & p_Result_i_reg_331);
    ...
    sendWord_data_V_fu_229_p3 <= 
        p_Result_5_fu_167_p2 when (ap_sig_allocacmp_ls_firstWord_load(0) = '1') else 
        p_Result_7_fu_205_p3;
    sendWord_keep_V_fu_221_p3 <= 
        p_Result_6_fu_177_p3 when (ap_sig_allocacmp_ls_firstWord_load(0) = '1') else 
        p_Result_8_fu_213_p3;
    sendWord_last_V_fu_237_p2 <= "1" when (p_Result_15_i_fu_185_p4 = ap_const_lv8_0) else "0";
    tmp_last_V_fu_155_p1 <= s_axis_tx_data_TLAST;
    tmp_nbreadreq_fu_76_p5 <= (0=>(s_axis_tx_data_TVALID), others=>'-');
    trunc_ln647_2_fu_173_p1 <= s_axis_tx_data_TKEEP(56 - 1 downto 0);
    trunc_ln647_fu_163_p1 <= s_axis_tx_data_TDATA(448 - 1 downto 0);

    tx_shift2udpFifo_V_d_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tx_shift2udpFifo_V_d_full_n, ls_writeRemainder_lo_reg_305, ap_predicate_op40_write_state2, ap_block_pp0_stage0)
    begin
    ...
    tx_shift2udpFifo_V_d_din_assign_proc : process(ls_writeRemainder_lo_reg_305, ap_predicate_op40_write_state2, sendWord_data_V_reg_321, p_Result_s_fu_289_p3, ap_condition_170)
    begin
    ...
    tx_shift2udpFifo_V_d_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ls_writeRemainder_lo_reg_305, ap_predicate_op40_write_state2, ap_block_pp0_stage0_11001)
    begin
    ...
    tx_shift2udpFifo_V_k_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tx_shift2udpFifo_V_k_full_n, ls_writeRemainder_lo_reg_305, ap_predicate_op40_write_state2, ap_block_pp0_stage0)
    begin
        if ((((ls_writeRemainder_lo_reg_305 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0)) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_predicate_op40_write_state2 = ap_const_boolean_1) and (ap_const_boolean_0 = ap_block_pp0_stage0)))) then 
    ...
    tx_shift2udpFifo_V_k_din_assign_proc : process(ls_writeRemainder_lo_reg_305, ap_predicate_op40_write_state2, sendWord_keep_V_reg_316, p_Result_4_fu_297_p3, ap_condition_170)
    begin
        if ((ap_const_boolean_1 = ap_condition_170)) then
            if ((ls_writeRemainder_lo_reg_305 = ap_const_lv1_1)) then 
    ...
    tx_shift2udpFifo_V_k_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ls_writeRemainder_lo_reg_305, ap_predicate_op40_write_state2, ap_block_pp0_stage0_11001)
    begin
        if ((((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ls_writeRemainder_lo_reg_305 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_predicate_op40_write_state2 = ap_const_boolean_1)))) then 
    ...
    tx_shift2udpFifo_V_l_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tx_shift2udpFifo_V_l_full_n, ls_writeRemainder_lo_reg_305, ap_predicate_op40_write_state2, ap_block_pp0_stage0)
    begin
        if ((((ls_writeRemainder_lo_reg_305 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0)) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_predicate_op40_write_state2 = ap_const_boolean_1) and (ap_const_boolean_0 = ap_block_pp0_stage0)))) then 
    ...
    tx_shift2udpFifo_V_l_din_assign_proc : process(ls_writeRemainder_lo_reg_305, ap_predicate_op40_write_state2, sendWord_last_V_reg_326, ap_condition_170)
    begin
        if ((ap_const_boolean_1 = ap_condition_170)) then
            if ((ls_writeRemainder_lo_reg_305 = ap_const_lv1_1)) then 
    ...
    tx_shift2udpFifo_V_l_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ls_writeRemainder_lo_reg_305, ap_predicate_op40_write_state2, ap_block_pp0_stage0_11001)
    begin
        if ((((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ls_writeRemainder_lo_reg_305 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_predicate_op40_write_state2 = ap_const_boolean_1)))) then 
