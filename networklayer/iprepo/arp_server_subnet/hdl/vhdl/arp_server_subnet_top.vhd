...
architecture behav of arp_server_subnet_top is 
    ...
    signal process_arp_pkg_512_U0_arpTableInsertFifo_V_din : STD_LOGIC_VECTOR (80 downto 0);
    signal process_arp_pkg_512_U0_arpTableInsertFifo_V_write : STD_LOGIC;
    signal process_arp_pkg_512_U0_arpReplyMetaFifo_V_din : STD_LOGIC_VECTOR (127 downto 0);
    signal process_arp_pkg_512_U0_arpReplyMetaFifo_V_write : STD_LOGIC;
    signal process_arp_pkg_512_U0_s_axis_TREADY : STD_LOGIC;
    signal process_arp_pkg_512_U0_regRequestCount_V : STD_LOGIC_VECTOR (15 downto 0);
    signal process_arp_pkg_512_U0_regRequestCount_V_ap_vld : STD_LOGIC;
    signal process_arp_pkg_512_U0_regReplyCount_V : STD_LOGIC_VECTOR (15 downto 0);
    signal process_arp_pkg_512_U0_regReplyCount_V_ap_vld : STD_LOGIC;
    ...
    signal generate_arp_pkg_U0_arpReplyMetaFifo_V_read : STD_LOGIC;
    ...
    component process_arp_pkg_512_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
...
begin
    process_arp_pkg_512_U0 : component process_arp_pkg_512_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
