...
(* CORE_GENERATION_INFO="arp_server_subnet_top,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xcu280-fsvh2892-2L-e,HLS_INPUT_CLOCK=3.200000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.558000,HLS_SYN_LAT=5,HLS_SYN_TPT=1,HLS_SYN_MEM=4,HLS_SYN_DSP=0,HLS_SYN_FF=1153,HLS_SYN_LUT=5726,HLS_VERSION=2020_1}" *)
...
wire   [80:0] process_arp_pkg_512_U0_arpTableInsertFifo_V_din;
wire    process_arp_pkg_512_U0_arpTableInsertFifo_V_write;
wire   [127:0] process_arp_pkg_512_U0_arpReplyMetaFifo_V_din;
wire    process_arp_pkg_512_U0_arpReplyMetaFifo_V_write;
wire    process_arp_pkg_512_U0_s_axis_TREADY;
wire   [15:0] process_arp_pkg_512_U0_regRequestCount_V;
wire    process_arp_pkg_512_U0_regRequestCount_V_ap_vld;
wire   [15:0] process_arp_pkg_512_U0_regReplyCount_V;
wire    process_arp_pkg_512_U0_regReplyCount_V_ap_vld;
...
process_arp_pkg_512_s process_arp_pkg_512_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    ...
    .arpTableInsertFifo_V_din(process_arp_pkg_512_U0_arpTableInsertFifo_V_din),
    .arpTableInsertFifo_V_full_n(arpTableInsertFifo_V_full_n),
    .arpTableInsertFifo_V_write(process_arp_pkg_512_U0_arpTableInsertFifo_V_write),
    .arpReplyMetaFifo_V_din(process_arp_pkg_512_U0_arpReplyMetaFifo_V_din),
    .arpReplyMetaFifo_V_full_n(arpReplyMetaFifo_V_full_n),
    .arpReplyMetaFifo_V_write(process_arp_pkg_512_U0_arpReplyMetaFifo_V_write),
    .s_axis_TDATA(s_axis_TDATA),
    .s_axis_TREADY(process_arp_pkg_512_U0_s_axis_TREADY),
    .s_axis_TKEEP(s_axis_TKEEP),
    .s_axis_TLAST(s_axis_TLAST),
    .myIpAddress_V(myIpAddress_V),
    .regRequestCount_V(process_arp_pkg_512_U0_regRequestCount_V),
    .regRequestCount_V_ap_vld(process_arp_pkg_512_U0_regRequestCount_V_ap_vld),
    .regReplyCount_V(process_arp_pkg_512_U0_regReplyCount_V),
    .regReplyCount_V_ap_vld(process_arp_pkg_512_U0_regReplyCount_V_ap_vld)
);
...
fifo_w128_d4_A arpReplyMetaFifo_V_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(process_arp_pkg_512_U0_arpReplyMetaFifo_V_din),
    .if_full_n(arpReplyMetaFifo_V_full_n),
    .if_write(process_arp_pkg_512_U0_arpReplyMetaFifo_V_write),
...
fifo_w81_d4_A arpTableInsertFifo_V_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(process_arp_pkg_512_U0_arpTableInsertFifo_V_din),
    .if_full_n(arpTableInsertFifo_V_full_n),
    .if_write(process_arp_pkg_512_U0_arpTableInsertFifo_V_write),
...
assign regReplyCount_V = process_arp_pkg_512_U0_regReplyCount_V;

assign regReplyCount_V_ap_vld = process_arp_pkg_512_U0_regReplyCount_V_ap_vld;

assign regRequestCount_V = process_arp_pkg_512_U0_regRequestCount_V;

assign regRequestCount_V_ap_vld = process_arp_pkg_512_U0_regRequestCount_V_ap_vld;
